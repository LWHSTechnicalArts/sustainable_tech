// Lights LED for one second, then goes to deep sleep for five.
// After five seconds the timer restarts the micro.

#define uS_TO_S_FACTOR 1000000ULL  // Microseconds to seconds conversion
#define SLEEP_TIME 5                // Sleep for 5 seconds
#define LED_TIME 1000               // LED on for 1000ms (1 second)
...
void setup() {
  ...
  // Disable NeoPixel power (saves ~quiescent current during sleep)
  pinMode(NEOPIXEL_POWER, OUTPUT);
  digitalWrite(NEOPIXEL_POWER, LOW);

  // Disable STEMMA QT / I2C power (prevents ~330uA bleed through pull-down resistor)
